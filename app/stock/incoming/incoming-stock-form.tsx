  ...
  return (
    <form action={action} className="mt-8 space-y-6">
      ...
      <div className="pt-1">
        <button
          type="submit"
          className="inline-flex w-full items-center justify-center rounded-2xl bg-slate-950 px-5 py-4 text-sm font-semibold text-white shadow-[0_16px_30px_rgba(15,23,42,0.18)] transition hover:bg-emerald-700"
        >
      ...
      <BarcodeScanDialog
        open={scannerOpen}
        title="Skano per hyrje stoku"
        description="Barcode-i kerkohet ne depon aktive. Varianti i lexuar zgjedhet automatikisht dhe vendoset me sasi 1."
